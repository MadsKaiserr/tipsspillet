    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Følgende af Tipsspillets betingelser er gældende i forbindelse med anvendelsen af Tipsspillet. Ved brug af internetsiden anerkender og tiltræder du vores betingelser." />
                ...
                <meta itemProp="description" content="Følgende af Tipsspillets betingelser er gældende i forbindelse med anvendelsen af Tipsspillet. Ved brug af internetsiden anerkender og tiltræder du vores betingelser." />
                <meta property="og:title" content="Betingelser - Tipsspillet" />
                <meta property="og:url" content="https://www.tipsspillet.dk/betingelser" />
                <meta property="og:description" content="Følgende af Tipsspillets betingelser er gældende i forbindelse med anvendelsen af Tipsspillet. Ved brug af internetsiden anerkender og tiltræder du vores betingelser." />
            </Head>
            <Header />
            <Spacer />
            <div className="law-main-container">
                ...
                <p className="betingelser-h2">Sidst opdateret 26. sep, 2022</p>
                ...
                <div className="betingelser-section">
                    <h2 className="betingelser-h3">Sektion A - Om Tipsspillet</h2>
                    <div className="betingelser-element">
                        <h3 className="betingelser-h4">1 - Hvem er vi?</h3>
                        <p className="betingelser-p">Tipsspillet er en dansk-ejet enkeltmandsvirksomhed, som er drevet af Mads Kaiser. Vi lader folk konkurrere med familie og venner i Oddset verdenen, uden nogen økonomisk risiko. Vi giver derved også individer under 18-år mulighed for at prøve kræfter af med Odds helt gratis. <br /><br />
                    ...
                    <div className="betingelser-element">
                        <h3 className="betingelser-h4">2 - Hvad er vores formål?</h3>
                        <p className="betingelser-p">Tipsspillet har til formål at tilbyde folk at få afprøvet deres Oddset evner uden økonomisk risiko. Vi stræber på, at kunden får den sjoveste oplevelse på platformen, og kan have en fed konkurrence med familie og venner.</p>
                    </div>
                </div>
                <div className="betingelser-section">
                    <h2 className="betingelser-h3">Sektion B - Generelle betingelser</h2>
                    <div className="betingelser-element">
                        <h3 className="betingelser-h4">1 - Ansvarsfraskrivelse</h3>
                    ...
                    <div className="betingelser-element">
                        <h3 className="betingelser-h4">2 - Rettigheder til sidens indhold</h3>
                    ...
                    <div className="betingelser-element">
                        <h3 className="betingelser-h4">3 - Privatlivspolitik</h3>
                    ...
                    <div className="betingelser-element">
                        <h3 className="betingelser-h4">4 - Tekniske problemer mm.</h3>
                    ...
                    <div className="betingelser-element">
                        <h3 className="betingelser-h4">5 - Lovvalg og værneting</h3>
                    ...
                    <div className="betingelser-element">
                        <h3 className="betingelser-h4">6 - Yderligere hjælp</h3>
                ...
                <div className="betingelser-section">
                    <h2 className="betingelser-h3">Sektion C - Benyttelse af siden</h2>
                    <div className="betingelser-element">
                        <h3 className="betingelser-h4">1 - Konto</h3>
                        <p className="betingelser-p">...</p>
                    </div>
                    <div className="betingelser-element">
                        <h3 className="betingelser-h4">2 - Tredjepartsoplysninger</h3>
                        <p className="betingelser-p">...</p>
                    </div>
                    <div className="betingelser-element">
                        <h3 className="betingelser-h4">3 - Præmieturneringer</h3>
                        <p className="betingelser-p">...</p>
                    </div>
                    <div className="betingelser-element">
                        <h3 className="betingelser-h4">4 - Fejl på data</h3>
                        <p className="betingelser-p">...</p>
                    </div>
                </div>
                </div>
