...
function StageHeader () {
    ...
    useEffect(() => {
        ...
        if (cookie.get("notifikationer")) {
            setNotifikationer(cookie.get("notifikationer"));
        }
    }, [])
    ...
    const [notifikationer, setNotifikationer] = useState(0);
        ...
        <>
            <header className="nav-bar-stage" id="nav-small-bar">
                <div className="nav-container-top-stage">
                    ...
                    <div className="nav-container-stage-right">
                        <div className="nav-profile">
                            ...
                            <div className="nav-link">
                                {notifikationer > 0 && <div className="noti-icon" id="notital">{notifikationer}</div>}
                            ...
                            <div className="nav-icons">
                                <Link href="/stage/gruppespil?kuponer=true">
                                    <p className="user-nav-p">Mine væddemål</p>
                                </Link>
                                <Link href="/stage/search">
                ...
                <nav className="nav-container-bottom" id="nav-bar">
                    ...
                    <div className="nav-link-container">
                        <Link href="/stage/gruppespil?kuponer=true"><a className="nav-p-stage">Mine væddemål</a></Link>
                    </div>
                </nav>
            </header>
        </>
