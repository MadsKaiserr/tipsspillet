                    ...
                    <div className="gruppespil-section" style={{border: "0px", marginTop: "20px"}}>
                                    ...
                                    {tableArray.map((item, index) => {
                                        ...
                                        if (tableArray.length > 10) {
                                            if (index >= ((sidetal - 1) * 7) && index < (sidetal * 7) && index < (tableArray.length - 3)) {
                                                return (
                                                    <li key={item.player} onClick={() => getPlayer(item.player)}>
                                            ...
                                            if (getEmail === item.player && index > 7 && index < (tableArray.length - 3)) {
                                                return (<>
                        ...
                        {synlighed !== "privat" && <div className="gruppespil-info">
                            ...
                            <div className="inv-element-a" onClick={() => {
                                const queryString = window.location.search;
                                const urlParams = new URLSearchParams(queryString);
                                if (urlParams.get('game') && urlParams.get('game') !== null && urlParams.get('game') !== undefined) {navigator.clipboard.writeText("https://www.tipsspillet.dk/gruppesession?game=" + urlParams.get('game') + "&type=invite"); document.getElementById("copied").classList.remove("display-not"); setTimeout(function (){
