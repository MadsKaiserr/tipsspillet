        ...
        <>
            <div className="main-container">
                <div className="hero-text">
                    ...
                    <h2 className="main-component-h3 animation-fadetop animation-delay-300">Betal hver 3. måned - Lav dine egne gruppespil, få udvidet statistikker, deltag i <span className="color-primary font-weight-500">præmiedyster</span> og meget mere.</h2>
                </div>
            </div>
